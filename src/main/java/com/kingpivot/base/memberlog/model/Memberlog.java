...
public class Memberlog extends BaseModel<String> {
    ...
    public enum MemberOperateType {
        ...
        REMOVECOLLECT("删除收藏"),SUBMITONEFEE("提交一个意见反馈"),GETMYMEMBERBONUSLIST("获取我的会员红包列表"),USEMEMBERBONUS("使用会员红包"),SENDMEMBERBONUS("赠送会员红包"),
        APPAPPLYMEMBERORDERPAY("APP申请订单支付"),MONTHBALANCEAPPLYMEMBERORDERPAY("月结金额支付订单"),APPLYMEMBERRECHARGEPAY("会员充值申请支付"),SUBMITONESIGNIN("会员签到"),GETSIGNINLIST("获取签到记录"),GETMYPOINTLIST("获取我的积分列表"),
