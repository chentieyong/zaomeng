...
public class Memberlog extends BaseModel<String> {
    ...
    public enum MemberOperateType {
        ...
        GETMYMESSAGELIST("获取我的消息列表"),GETMESSAGEDETAIL("获取消息详情"),CANCELMEMBERORDER("取消订单"),CONFIRMMEMBERORDER("确认收货"),APPLYMEMBERORDERGOODSRETURN("申请订单商品退货"),
        ...
        REMOVEONEMEMBERADDRESS("删除会员地址"),GETMEMBERADDRESSLIST("获取会员地址列表"),GETMEMBERADDRESSDETAIL("获取会员地址详情");
