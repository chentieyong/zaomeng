...
public interface MemberOrderService extends BaseService<MemberOrder, String> {
     ...
     * @return
     */
    String createMemberOrderFromCart(List<CartGoods> cartGoodsList, Member member, String contactName, String contactPhone, String address, String memberBonusID, String sendType, String pointPrice, int point, String tableNumber);
