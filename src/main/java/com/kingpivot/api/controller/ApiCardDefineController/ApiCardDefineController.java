...
@RequestMapping("/api")
@RestController
@Api(description = "卡定义管理接口")
public class ApiCardDefineController extends ApiBaseController {
    ...
    @RequestMapping(value = "/getCardDefineList")
    public MessagePacket getCardDefineList(HttpServletRequest request) {
        ...
        Page<CardDefine> rs = cardDefineService.list(paramMap, pageable);
        ...
        String desc = String.format("%s获取卡定义列表", member.getName());
        UserAgent userAgent = UserAgentUtil.getUserAgent(request.getHeader("user-agent"));
        MemberLogRequestBase base = MemberLogRequestBase.BALANCE()
                .sessionID(sessionID)
                .description(desc)
                .userAgent(userAgent == null ? null : userAgent.getBrowserType())
                .operateType(Memberlog.MemberOperateType.GETCARDDEFINELIST.getOname())
                .build();
