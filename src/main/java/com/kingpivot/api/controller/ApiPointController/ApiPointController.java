package com.kingpivot.api.controller.ApiPointController;

import com.google.common.collect.Maps;
import com.kingpivot.api.dto.point.MyPointListDto;
...
@RequestMapping("/api")
@RestController
@Api(description = "积分管理接口")
public class ApiPointController extends ApiBaseController {
    ...
    public MessagePacket getMyPointList(HttpServletRequest request) {
        ...
        MemberLogRequestBase base = MemberLogRequestBase.BALANCE()
                ...
                .operateType(Memberlog.MemberOperateType.GETMYPOINTLIST.getOname())
                .build();
