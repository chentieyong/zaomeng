...
public class MemberStatisticsInfoDto {
    ...
    public int getGoodsShopBrowseNum() {
        return goodsShopBrowseNum;
    }

    public void setGoodsShopBrowseNum(int goodsShopBrowseNum) {
        this.goodsShopBrowseNum = goodsShopBrowseNum;
    }
